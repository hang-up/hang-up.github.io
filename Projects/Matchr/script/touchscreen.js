...
//    "use strict";
    ...
    $("#start").click(function() {        
        $(this).parent().animate({
            ...
            $(this).remove();  
            $('body').append("<div id='color-canvas'><p class='caption top-padding'  id=indicator>Start by moving the mouse... <br /> (Ipad/Ipod and any kind of full touch devices are not supported ... yet. I know it's lame.)</p><p id='color-code'></p></div>");
            $("#action-bar").fadeIn();
        });
    });
