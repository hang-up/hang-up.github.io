var HomepageVideo = React.createClass({displayName: "HomepageVideo",
  render: function() {
    return (
      React.createElement("div", {className: "ui container"}, 
        React.createElement("video", {autoPlay: true, loop: true, muted: true, id: "bgvid", onCanPlay: this.props.onLoadedFinish}, 
            React.createElement("source", {src: "asset/fall.mp4", type: "video/mp4"})
        )
      )
    );
  }
...
var HomepageContainer = React.createClass({displayName: "HomepageContainer",
  ...
  */
  render: function() {
    return (
      React.createElement("div", {className: "homepage-content"}, 
      ...
      React.createElement(HomepageVideo, {onLoadedFinish: this.progressFinish}), 

      React.createElement(HomepageGrid, null)
...
var HomepageGrid = React.createClass({displayName: "HomepageGrid",
  render: function() {
    return (
      React.createElement("div", {className: "ui grid"}, 

            React.createElement("div", {className: "row"}, 
              React.createElement("div", {className: "sixteen wide column center aligned"}, 
                React.createElement("img", {src: "asset/logo.png", alt: "Hang Up!", id: "homepage-content-logo", className: "ui centered large image"})
              )
            ), 
...
var Preloader = React.createClass({displayName: "Preloader",
  render: function() {
    ...
    return (
      React.createElement("div", {className: preloaderClass}, 

          React.createElement("div", {id: "preloader-topPanel", className: panelClass}), 

          React.createElement("div", {id: "preloader-bottomPanel", className: panelClass}, 
            React.createElement("div", {className: "preloader-title text-center"}, 
...
var WorkshopGrid = React.createClass({displayName: "WorkshopGrid",
  render: function() {
    var item = this.props.data.map(function(item, index) {
      return (
        React.createElement(WorkshopItem, {key: index, title: item.name, caption: item.caption, thumbnail: item.thumbnail, link: item.link})
      )
    });
...
; (function(window, document, $) {
  $(document).ready(function() {
    ...
    *
    */
    ReactDOM.render(React.createElement(HomepageContainer, null), document.getElementsByClassName('homepage-container')[0]);
    ReactDOM.render(React.createElement(WorkshopGrid, {data: valet.data}), document.getElementById("workshop-grid"));
